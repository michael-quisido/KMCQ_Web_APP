...
export default function AboutContent({ title }: { title: string }) {
  return (
    <div style={{ backgroundColor: "#ffffff", padding: "60px 20px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: "column" }}>
        <h1 style={{ color: "#040f2d", fontSize: 37, fontWeight: "bold", fontFamily: "Arial, Helvetica, sans-serif", marginBottom: 30 }}>
          {title}
        </h1>
        <p style={{ color: "#040f2d", fontSize: 16, lineHeight: 1.8, fontFamily: "Arial, Helvetica, sans-serif", marginBottom: 20 }}>
        ...
        <p style={{ color: "#040f2d", fontSize: 16, lineHeight: 1.8, fontFamily: "Arial, Helvetica, sans-serif" }}>
